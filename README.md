...
Computes technical indicators (Bollinger %B, RSI, MACD, Golden Cross)

Trains a bagged ensemble of random trees (BagLearner + RTLearner)

Selects optimal hyperparameters (horizon, threshold, leaf_size) using validation CR

Outputs daily trade signals (testPolicy) for simulation
